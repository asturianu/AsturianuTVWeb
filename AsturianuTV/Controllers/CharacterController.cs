...
namespace AsturianuTV.Controllers
{
    public class CharacterController : Controller
    {
        ...
        public async Task<IActionResult> Details(int id) 
        {
            ...
            var matchUp = await GetHeroeMatchup(id);
            var listBestHeroes = await AddBestHeroesToPick(matchUp, id);
            var listWorstHeroes = await AddWorstHeroesToPick(matchUp, id);

            var popularItems = await GetPopularItemsForHeroe(id);
